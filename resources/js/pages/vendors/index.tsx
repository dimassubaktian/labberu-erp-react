        ...
        <div className="flex flex-col items-center justify-center gap-3 text-center">
            ...
            <div className="space-y-1">
                ...
                <p className="text-sm text-muted-foreground">
                    {hasActiveFilters
                        ? 'Try clearing the search or using a different vendor name or code.'
                        : 'Create a vendor to start managing procurement partners.'}
                </p>
            </div>
            {hasActiveFilters ? (
...
export default function VendorsIndex({ vendors, filters }: Props) {
    ...
    const resultSummary =
        vendors.from !== null && vendors.to !== null
