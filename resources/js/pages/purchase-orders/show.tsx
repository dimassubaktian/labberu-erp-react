            ...
            <div className="mx-auto w-full max-w-7xl space-y-6 p-4 sm:p-6">
                ...
                <Card>
                    <CardHeader className="border-b border-border/60 pb-5">
                        ...
                        <CardDescription>
                            Vendor, delivery, payment, and procurement terms.
                        </CardDescription>
                    </CardHeader>
                ...
                <Card>
                    <CardHeader className="border-b border-border/60 pb-5">
                        ...
                        <CardDescription>
                            Instructions and additional purchasing context.
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="pt-6">
                ...
                <Card>
                    <CardHeader className="gap-3 border-b border-border/60 pb-5 sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            ...
                            <CardDescription>
                                Products and services ordered from this vendor.
                            </CardDescription>
                        </div>
                ...
                {purchaseOrder.discounts.length > 0 && (
                    <Card>
                        <CardHeader className="border-b border-border/60 pb-5">
                            ...
                            <CardDescription>
                                Sequential discounts applied to this order.
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="pt-6">
                            <div className="overflow-hidden rounded-xl border border-border/60">
                ...
                <Card className="border-primary/20 bg-primary/[0.02]">
                    <CardHeader className="border-b border-primary/10 pb-5">
                        ...
                        <CardDescription>
                            Final procurement cost after discounts and tax.
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="pt-6">
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="mt-1 text-sm text-muted-foreground">
                                    These actions cancel or permanently remove
                                    this purchase order.
                                </p>
                            </div>
                        </div>
