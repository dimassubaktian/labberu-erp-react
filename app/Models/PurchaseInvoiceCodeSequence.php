...
class PurchaseInvoiceCodeSequence extends Model
{
    /**
     * Generate the next sequential purchase invoice number for the given year, resetting back
     * to 1 whenever the year changes.
     */
